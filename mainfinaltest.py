...
def recognize_speech():  # Function to recognize speech and display ISL
    ...
    isl_gif = [  # List of phrases for Indian Sign Language (ISL)
        ...
        'good afternoon', 'good morning', 'good question', 'hello what is your name',
        ...
        'you are wrong', 'address', 'agra', 'ahemdabad', 'all', 'april', 
        'assam', 'august', 'australia', 'badoda', 'banana', 'banaras', 
        'banglore', 'bihar', 'bridge', 'cat', 'chandigarh', 'chennai', 
        'christmas', 'church', 'clinic', 'coconut', 'crocodile', 'dasara',
        'deaf', 'december', 'deer', 'delhi', 'dollar', 'duck', 'febuary', 
        'friday', 'fruits', 'glass', 'grapes', 'gujrat', 'hello', 'hindu', 
        'hyderabad', 'india', 'january', 'jesus', 'job', 'july', 'karnataka', 
        'kerala', 'krishna', 'litre', 'mango', 'may', 'mile', 'monday', 
        'mumbai', 'museum', 'muslim', 'nagpur', 'october', 'orange', 
        'pakistan', 'pass', 'police station', 'post office', 'pune', 
        'punjab', 'rajasthan', 'ram', 'restaurant', 'saturday', 'september', 
        'shop', 'sleep', 'southafrica', 'story', 'sunday', 'tamil nadu', 
        'temperature', 'temple', 'thursday', 'toilet', 'tomato', 'town', 
        'tuesday', 'usa', 'village', 'voice', 'wednesday', 'weight', 
        'please wait for sometime', 'what are you doing', 'are you busy'
    ]
    ...
    with sr.Microphone() as source:
        ...
        while True:  # Main loop for speech recognition
            ...
            try:
                ...
                if a.lower() in ['goodbye', 'good bye', 'bye']:  # Exit commands
                    ...
                    lbl = ImageLabel(root)
                    lbl.pack()
                    base_dir = os.path.dirname(os.path.abspath(__file__))  # Get main file directory
                    ...
                    for i in range(len(a)):
                        if a[i] in arr:
                            ...
                            try:
                                ...
                                print(f"Image not found: {ImageAddress}")
